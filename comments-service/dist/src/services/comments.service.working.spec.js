...
describe('CommentsService Working Tests', () => {
    ...
    describe('update', () => {
        it('should update an approved comment', async () => {
            const approvedComment = { ...mockComment, status: comment_entity_1.CommentStatus.APPROVED };
    ...
    describe('moderate', () => {
        it('should moderate a comment successfully', async () => {
            ...
            expect(result.status).toBe(comment_entity_1.CommentStatus.APPROVED);
        });
        it('should throw error when rejecting without reason', async () => {
            const moderateDto = {
                status: comment_entity_1.CommentStatus.REJECTED,
            };
            mockRepository.findOne.mockResolvedValue(mockComment);
...
//# sourceMappingURL=comments.service.working.spec.js.map